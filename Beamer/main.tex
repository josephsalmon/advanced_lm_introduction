...
\rem If $f$ is a $C^{\infty}$ function, then it is differentiable
...
& \iff \langle X_{j},y-X\beta\rangle=0 \text{for}  j \in [p]\\
\end{align*}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\rem
    \begin{itemize}
        ...
        \item If $\hat{\Sigma}$ invertible, so ${\rm rank}(\hat{\Sigma})=p$
...
\mytheorem{Result}{
\begin{itemize}
    \item  If ${\rm rank}(X)=p$, so $\hat{\Sigma}$ is invertible and : $$\hat{\beta}^{\rm LS}=\hat{\Sigma}^{-1}\frac{X^{\top} y}{n}=(\frac{X^{\top} y}{n})^{-1} \frac{X^{\top} y}{n}$$
...
\rem In practice it is exceptional to invert $\hat{\Sigma} $ because one solves many linear systems
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\end{itemize}
XXX % XXX TODO: details better the dataset
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
